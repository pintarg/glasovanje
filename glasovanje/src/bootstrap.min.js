            ...
            var b = "alert",
                ...
                o = function() {
                    ...
                    return b.prototype.close = function(a) {
                        ...
                        var c = this;
                        return a(b).removeClass(n.ACTIVE), f.supportsTransitionEnd() && a(b).hasClass(n.FADE) ? void a(b).one(f.TRANSITION_END, function(a) {
            ...
            var b = "collapse",
                ...
                s = function() {
                    ...
                    return i.prototype.toggle = function() {
                        a(this._element).hasClass(p.ACTIVE) ? this.hide() : this.show()
                    }, i.prototype.show = function() {
                        var b = this;
                        if (!this._isTransitioning && !a(this._element).hasClass(p.ACTIVE)) {
                            var c = void 0,
                                d = void 0;
                            if (this._parent && (c = a.makeArray(a(this._parent).find(r.ACTIVES)), c.length || (c = null)), !(c && (d = a(c).data(h), d && d._isTransitioning))) {
                                ...
                                if (a(this._element).trigger(e), !e.isDefaultPrevented()) {
                                    ...
                                    var j = function() {
                                        a(b._element).removeClass(p.COLLAPSING).addClass(p.COLLAPSE).addClass(p.ACTIVE), b._element.style[g] = "", b.setTransitioning(!1), a(b._element).trigger(o.SHOWN)
                                    };
                ...
                r = function() {
                    ...
                    return b.prototype.toggle = function() {
                        ...
                        var f = {
                            ...
                            g = a.Event(o.SHOW, f);
                        return a(c).trigger(g), !g.isDefaultPrevented() && (this.focus(), this.setAttribute("aria-expanded", !0), a(c).toggleClass(p.ACTIVE), a(c).trigger(a.Event(o.SHOWN, f)), !1)
                    }, b.prototype.dispose = function() {
                        ...
                        if (!c || c.which !== n) {
                            ...
                            for (var e = a.makeArray(a(q.DATA_TOGGLE)), f = 0; f < e.length; f++) {
                                ...
                                if (a(g).hasClass(p.ACTIVE) && !(c && "click" === c.type && /input|textarea/i.test(c.target.tagName) && a.contains(g, c.target))) {
                                    var i = a.Event(o.HIDE, h);
                                    a(g).trigger(i), i.isDefaultPrevented() || (e[f].setAttribute("aria-expanded", "false"), a(g).removeClass(p.ACTIVE).trigger(a.Event(o.HIDDEN, h)))
                                }
                            }
                        }
            ...
            var b = "modal",
                ...
                t = function() {
                    ...
                    return j.prototype.toggle = function(a) {
                        ...
                        var c = this;
                        b && b.preventDefault();
                        var d = a.Event(q.HIDE);
                        a(this._element).trigger(d), this._isShown && !d.isDefaultPrevented() && (this._isShown = !1, this._setEscapeEvent(), this._setResizeEvent(), a(document).off(q.FOCUSIN), a(this._element).removeClass(r.ACTIVE), a(this._element).off(q.CLICK_DISMISS), a(this._dialog).off(q.MOUSEDOWN_DISMISS), f.supportsTransitionEnd() && a(this._element).hasClass(r.FADE) ? a(this._element).one(f.TRANSITION_END, function(a) {
                        ...
                        this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.scrollTop = 0, d && f.reflow(this._element), a(this._element).addClass(r.ACTIVE), this._config.focus && this._enforceFocus();
                        ...
                        var b = this;
                        this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._showBackdrop(function() {
                        ...
                        if (this._isShown && this._config.backdrop) {
                            ...
                            if (this._backdrop = document.createElement("div"), this._backdrop.className = r.BACKDROP, d && a(this._backdrop).addClass(d), a(this._backdrop).appendTo(document.body), a(this._element).on(q.CLICK_DISMISS, function(a) {
                                ...
                                }), e && f.reflow(this._backdrop), a(this._backdrop).addClass(r.ACTIVE), !b) return;
                            if (!e) return void b();
                            a(this._backdrop).one(f.TRANSITION_END, b).emulateTransitionEnd(m)
                        } else if (!this._isShown && this._backdrop) {
                            a(this._backdrop).removeClass(r.ACTIVE);
                            var g = function() {
                ...
                v = function() {
                    ...
                    return j.prototype.enable = function() {
                        ...
                        if (b) {
                            ...
                            if (a(this.getTipElement()).hasClass(r.ACTIVE)) return void this._leave(null, this);
                        ...
                        if (this.isWithContent() && this._isEnabled) {
                            ...
                            a(e).data(this.constructor.DATA_KEY, this).appendTo(k), a(this.element).trigger(this.constructor.Event.INSERTED), this._tether = new Tether({
                                ...
                                addTargetClasses: !1
                            }), f.reflow(e), this._tether.position(), a(e).addClass(r.ACTIVE);
                            var m = function() {
                                var c = b._hoverState;
                                b._hoverState = null, a(b.element).trigger(b.constructor.Event.SHOWN), c === p.OUT && b._leave(null, b)
                            };
                            if (f.supportsTransitionEnd() && a(this.tip).hasClass(r.FADE)) return void a(this.tip).one(f.TRANSITION_END, m).emulateTransitionEnd(j._TRANSITION_DURATION);
                            m()
                        }
                    }, j.prototype.hide = function(b) {
                        var c = this,
                            ...
                            g = function() {
                                c._hoverState !== p.ACTIVE && d.parentNode && d.parentNode.removeChild(d), c.element.removeAttribute("aria-describedby"), a(c.element).trigger(c.constructor.Event.HIDDEN), c.cleanupTether(), b && b()
                            };
                        a(this.element).trigger(e), e.isDefaultPrevented() || (a(d).removeClass(r.ACTIVE), f.supportsTransitionEnd() && a(this.tip).hasClass(r.FADE) ? a(d).one(f.TRANSITION_END, g).emulateTransitionEnd(k) : g(), this._hoverState = "")
                        ...
                        this.setElementContent(b.find(s.TOOLTIP_INNER), this.getTitle()), b.removeClass(r.FADE).removeClass(r.ACTIVE), this.cleanupTether()
        ...
        var h = "popover",
            ...
            r = function(g) {
                ...
                return b(l, g), l.prototype.isWithContent = function() {
                    ...
                    this.setElementContent(a.find(p.TITLE), this.getTitle()), this.setElementContent(a.find(p.CONTENT), this._getContent()), a.removeClass(o.FADE).removeClass(o.ACTIVE), this.cleanupTether()
